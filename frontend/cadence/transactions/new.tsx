...
async function executeCadenceCode(): Promise<void> {
    try {
      const result = await fcl.send([
        fcl.transaction(cadenceCode),
        fcl.args([
          fcl.arg("collectionIdentifier", fcl.String("my-collection")),
          fcl.arg("saleItemID", fcl.UInt64(1)),
          fcl.arg("saleItemPrice", fcl.UFix64(100)),
          fcl.arg("customID", fcl.Optional(fcl.String("my-custom-id"))),
          fcl.arg("buyer", fcl.Optional(fcl.Address("0x123456789abcdef"))),
          fcl.arg("expiry", fcl.UInt64(1234567890)),
        ]),
      ...
      await fcl.tx(result).onceSealed();
